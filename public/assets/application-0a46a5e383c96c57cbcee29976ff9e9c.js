...
(function() {
  ...
  ready = function() {
    var email;
    email = null;
    return $("#email-submit").submit(function(e) {
      ...
      }).fail(function(error) {}).success(function() {
        $("#sign-up-modal").modal();
        return $("#sign-up-modal").on("shown.bs.modal", function() {
          $("#email-field-modal").val(email);
          return $("#first-name").focus();
        });
      });
    });
  };
...
(function() {
  ...
  ready = function() {
    ...
    $("#js-business-tags_tag").css({
      "width": "100%"
    });
    return $("#js-business-tags_tagsinput").css({
      "marginLeft": "-10px"
    });
  };
...
(function() {
  ...
  ready = function() {
    return $(".js-top-search").on("click", function() {
      return $(this).animate({
        width: "250px"
      });
    });
...
(function() {
  ...
  window.bindUpload = function(form) {
...
(function() {
  ...
  ready = function() {
    ahoy.trackClicks();
    $('.feed__content').linkify({}, function() {});
    $(".feed__entry-select").select2();
    $(".feed__entry-select").change(function() {
      var action, idVal, img, name, objType, value;
      ...
      return $(".js-form-name").html(name);
    });
    return $(".js-feed-comment").on("click", function(e) {
      var commentElement;
      e.preventDefault();
      commentElement = $(this).closest(".feed__content-outer").find(".feed__comment-input");
      return commentElement.slideDown();
    });
  };
...
(function() {
  ...
  ready = function() {
    return $('#js-business-tags').tagsInput();
  };
...
(function() {
  ...
  ready = function() {
    var AudienceController;
    AudienceController = Paloma.controller('Me/Audience');
    return AudienceController.prototype.index = function() {
      $(".aud__entry-select").select2();
      return $(".feed__entry-select").change(function() {
        var form, idVal, value;
        value = JSON.parse($(this).val());
        idVal = value[1];
