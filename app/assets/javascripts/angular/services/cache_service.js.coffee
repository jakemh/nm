App.factory "CacheService", [
  ...
  ($cacheFactory, $q, UsersCache, MessagesCache, SentMessagesCache, ReceivedMessagesCache, BusinessesCache, FollowingCache, FollowersCache, ReviewsCache, BranchesCache, Restangular) ->
